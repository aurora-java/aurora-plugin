...
public class RuoKuaiUtil {
    ...
    public static String getInfo(String username, String password) {
        ...
        String result;
        try {
            result = RuoKuaiUtil.httpRequestData(
    ...
    public static String report(String username, String password, String softid, String softkey, String id) {
        ...
        String result;
        try {
            result = RuoKuaiUtil.httpRequestData("http://api.ruokuai.com/reporterror.xml",
                    param);
        } catch (IOException e) {
            result = "未知问题";
        }
    ...
    public static String createByPost(String username, String password,
        ...
        String param = String
                .format(
                        ...
                        username, password, typeid, timeout, softid, softkey);
        try {
            result = RuoKuaiUtil.httpPostImage("http://api.ruokuai.com/create.xml", param, byteArr);
        } catch(Exception e) {
            result = "未知问题";
        }
